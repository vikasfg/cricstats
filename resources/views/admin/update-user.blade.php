...
<div id="page-content">
	...
	<div class="content-header">
		<div class="header-section">
			<h1>
				<i class="gi gi-warning_sign"></i>Users<br>
	...
	<div class="row">
		<div class="col-md-12">
			...
			@if (session('confirm'))
			<div class="alert alert-success text-center">{{ session('confirm') }}
			</div>
			@endif
			<h4>
				@if (session('message'))
			...
			<div class="block">
				...
				{{ Form::open(array('url' => '/admin/update-user-data', 'method' =>
				'post', 'id' => 'form-validation', 'class' => 'form-horizontal
				form-bordered')) }}
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="val_username">Role <span
							class="text-danger">*</span></label>
						<div class="col-md-6">
							<div class="input-group">
								<select id="val_role" class="form-control" name="val_role"
									class="select-chosen" data-placeholder="Choose Category.."
									style="width: 250px;">
									<option value="User" @if($data->role == 'User') Selected
										@endif>User</option>
									<option value="Seller" @if($data->role == 'Seller') Selected
										@endif>Seller</option>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="val_username">Username
						...
						<div class="col-md-6">
							<div class="input-group">
								<!--  @foreach($errors->get('email')  as $message)
                                        			 ...
                                        			 @endforeach
 -->
								{{ Form::text('val_username', $data->name ,$attributes =
								array('placeholder'=>'Your username..',
								'class'=>"form-control",'id'=>"val_username") ) }} <span
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								{{ Form::email('val_email', $data->email ,$attributes =
						...
						<div class="col-md-6">
							<div class="input-group">
								<input type="password" id="val_password" name="val_password"
									class="form-control" placeholder="Choose a crazy one.."> <span
									class="input-group-addon"><i class="gi gi-asterisk"></i></span>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="val_confirm_password">Confirm
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="val_confirm_password">Status
							<span class="text-danger">*</span>
						</label>
						<div class="col-md-6">
							<div class="input-group">
								<input type="checkbox" id="status" name="status" value="1"
									class="form-control" @if($data->status == 'Active') checked
								@endif >
