...
.buyprice_bg {
	...
	<p>Try do a quick search or do a sort. Observe the graph updates in
		real-time.</p>
...
$dg->set_col_property ( 'MSRP', array (
		'classes' => 'msrp_bg' 
) );
$dg->set_col_property ( 'buyPrice', array (
		'classes' => 'buyprice_bg' 
) );
