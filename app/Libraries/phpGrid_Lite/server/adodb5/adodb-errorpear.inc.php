 ...
 *
 * @param $dbms the
 *        	RDBMS you are connecting to
 * @param $fn the
 *        	name of the calling function (in uppercase)
 * @param $errno the
 *        	native error number from the database
 * @param $errmsg the
 *        	native error msg from the database
 * @param $p1 $fn
 *        	specific parameter - see below
 * @param $P2 $fn
 *        	specific parameter - see below
 */
