...
if (PHP_VERSION < 5)
	include_once ('../../Libraries/phpGrid_Lite/server/adodb5/adodb-pear.inc.php');
	// --------------------------------------------------------------------------------------
...
function CheckWS($conn) {
	...
	include_once ('../../Libraries/phpGrid_Lite/server/adodb5/session/adodb-session.php');
...
*/
  ...
  KEY `myindex` (`row1`,`row2`)
	...
	print "<p>Test CSV</p>";
	include_once ('../../Libraries/phpGrid_Lite/server/adodb5/toexport.inc.php');
	// $ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	...
	if (reset ( $rs->fields ) != 1)
		...
		// ///////////////////////////////////////////////////////////
	include_once ('../../Libraries/phpGrid_Lite/server/adodb5/pivottable.inc.php');
...
include ("../../Libraries/phpGrid_Lite/server/adodb5/rsfilter.inc.php");
...
include_once ('../../Libraries/phpGrid_Lite/server/adodb5/adodb-time.inc.php');
if (isset ( $_GET ['time'] ))
	adodb_date_test ();
flush ();

include_once ('../../Libraries/phpGrid_Lite/server/adodb5/tests/testdatabases.inc.php');
