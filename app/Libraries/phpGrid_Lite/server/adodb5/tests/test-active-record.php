<?php
include_once ('../../Libraries/phpGrid_Lite/server/adodb5/adodb.inc.php');
include_once ('../../Libraries/phpGrid_Lite/server/adodb5/adodb-active-record.inc.php');

// uncomment the following if you want to test exceptions
if (@$_GET ['except']) {
	if (PHP_VERSION >= 5) {
		include ('../../Libraries/phpGrid_Lite/server/adodb5/adodb-exceptions.inc.php');
