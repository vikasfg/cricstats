...
/**
 * * where shown below.
 * Set your callback string immediately after creating the **
 */
/**
 * * grid object.
 * The querystring key is "__cbstr". Because conf.php runs on **
 */
/**
 * * every callback.
 * It's the place user to modify to suit their own situation. **
 */
/**
 * * For example: **
 */
