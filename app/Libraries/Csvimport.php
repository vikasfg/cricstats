...
class Csvimport {
	 ...
	 * @access public
	 * @param
	 *        	filepath string Location of the CSV file
	 * @param
	 *        	column_headers array Alternate values that will be used for array keys instead of first line of CSV
	 * @param
	 *        	detect_line_endings boolean When true sets the php INI settings to allow script to detect line endings. Needed for CSV files created on Macs.
	 * @param
	 *        	initial_line integer Sets the line of the file from which start parsing data.
	 * @param
	 *        	delimiter string The values delimiter (e.g. ";" or ",").
	 * @return array
	 */
					...
					foreach ( $column_headers as $key => $value ) // assumes there are as many columns as their are title columns
{
	 ...
	 * @access private
	 * @param
	 *        	detect_line_endings bool The flag bit
	 * @return void
	 */
	 ...
	 * @access private
	 * @param
	 *        	initial_line int Start parse from this line
	 * @return void
	 */
	 ...
	 * @access private
	 * @param
	 *        	initial_line string The values delimiter (eg. "," or ";")
	 * @return void
	 */
	 ...
	 * @access private
	 * @param
	 *        	column_headers array Alternate column_headers that will be used instead of first line of CSV
	 * @return void
	 */
